import { _t as AstroError, c as isRemotePath, d as removeBase, pt as UnknownContentCollectionError, st as RenderUndefinedEntryError, u as prependForwardSlash } from "./path_sSM-_Ejx.mjs";
import { B as date, G as safeParseAsync, H as object, R as generateCspDigest, S as unescapeHTML, U as string, f as renderTemplate, n as renderScriptElement, o as renderComponent, r as renderUniqueStylesheet, t as spreadAttributes, y as createHeadAndContent, z as array } from "./server_CxzrZujQ.mjs";
import { n as parse, r as unflatten, t as escape } from "./esm_H1HbcFi2.mjs";
import { t as createConsoleLogger } from "./console_Cu2FjiW4.mjs";
import { a as level, o as createComponent, r as VALID_INPUT_FORMATS } from "./consts_CrxX3-q1.mjs";
//#region node_modules/.pnpm/astro@7.3.3_@emnapi+core@1.11.3_@emnapi+runtime@1.11.3_@vercel+functions@3.9.8_jiti@1.21.7_yaml@2.9.1/node_modules/astro/dist/assets/runtime.js
...
`${DATA_STORE_VIRTUAL_ID}`;
//#endregion
//#region node_modules/.pnpm/astro@7.3.3_@emnapi+core@1.11.3_@emnapi+runtime@1.11.3_@vercel+functions@3.9.8_jiti@1.21.7_yaml@2.9.1/node_modules/astro/dist/assets/utils/resolveImports.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.3.3_@emnapi+core@1.11.3_@emnapi+runtime@1.11.3_@vercel+functions@3.9.8_jiti@1.21.7_yaml@2.9.1/node_modules/astro/dist/core/render-scope/scope.js
var SCOPE_KEY = /* @__PURE__ */ Symbol.for("astro:render-scope");
function getInstalledRenderScope() {
	return globalThis[SCOPE_KEY];
}
//#endregion
//#region node_modules/.pnpm/astro@7.3.3_@emnapi+core@1.11.3_@emnapi+runtime@1.11.3_@vercel+functions@3.9.8_jiti@1.21.7_yaml@2.9.1/node_modules/astro/dist/core/render-scope/record.js
function recordContentEntryRender(filePath) {
	if (!filePath) return;
	getInstalledRenderScope()?.getStore()?.contentEntries?.add(filePath);
}
//#endregion
//#region node_modules/.pnpm/astro@7.3.3_@emnapi+core@1.11.3_@emnapi+runtime@1.11.3_@vercel+functions@3.9.8_jiti@1.21.7_yaml@2.9.1/node_modules/astro/dist/content/data-store-source.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.3.3_@emnapi+core@1.11.3_@emnapi+runtime@1.11.3_@vercel+functions@3.9.8_jiti@1.21.7_yaml@2.9.1/node_modules/astro/dist/content/data-store.js
...
var ImmutableDataStore = class ImmutableDataStore {
	...
	*/
	static async fromModule() {
		try {
			const data = await import("./_astro_data-layer-content_BRhwwfGG.mjs");
...
//#endregion
//#region node_modules/.pnpm/astro@7.3.3_@emnapi+core@1.11.3_@emnapi+runtime@1.11.3_@vercel+functions@3.9.8_jiti@1.21.7_yaml@2.9.1/node_modules/astro/dist/content/loaders/errors.js
...
//#endregion
//#region node_modules/.pnpm/astro@7.3.3_@emnapi+core@1.11.3_@emnapi+runtime@1.11.3_@vercel+functions@3.9.8_jiti@1.21.7_yaml@2.9.1/node_modules/astro/dist/content/runtime.js
...
async function updateImageReferencesInBody(html, fileName) {
	...
	const { getImage } = await import("./_virtual_astro_get-image_Bavo4WUN.mjs");
...
//#endregion
export { getEntry as a, getCollection as i, formatDate as n, render as o, getEntrySlug as r, capitalize as t };
